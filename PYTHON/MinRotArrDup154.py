    ...
    def findMin(self, nums: list[int]) -> int:
        ...
        while left < right:
            ...
            # If mid element is less than rightmost, the minimum is in the left half or at mid
                ...
                right = mid
            # If they are equal, we can safely discard the duplicate rightmost element
            else:
                right -= 1
...
if __name__ == '__main__':
    ...
    # Parse the space-separated string into a list of integers
    nums = list(map(int, user_input.split()))
    
    # Instantiate the solution class and execute algorithm
    solution = MinRotArrDup154()
    print("Minimum element:", solution.findMin(nums))